...
// Views of Nathan Phillips Square, crossfaded in an alternating loop. Filenames
// have no spaces, so they're used as-is for the <img> src.
const IMAGES = [
  {
    ...
    <main className="min-h-screen w-full bg-black px-6 py-24 sm:px-10">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-3 text-sm text-white/60 sm:text-base">
          Three views of the square, from street level to overhead.
        </p>

        {/* Crossfade frame — all images stacked, opacity toggled per slide. */}
        <div
